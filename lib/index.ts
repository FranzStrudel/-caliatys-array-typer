export class ArrayTyper{
  public static typeArray<T>(c: {new(json: any) : T}, json: any[]) : T[]
  {
    if (!json)
      return [];
  ...
  public static typeArrayWithParam<T>(c: {new(json: any, param: any) : T}, json: any[], param: any) : T[]
  {
    if (!json)
      return [];
    if (typeof json === 'string')
  ...
  public static typeAsDict<T>(c: {new(json: any) : IDictDeserializable<T>}, json: any[]) : { [key : number] : T; }
  {
    if (!json)
      return {};
